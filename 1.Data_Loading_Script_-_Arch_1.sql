...
-- whenever I am pulling the file the file's format is this
...
-- to test the data insert
SELECT * from MIDTERM_DB.RAW.store limit 4;
...
select * from MIDTERM_DB.RAW.inventory limit 3;
